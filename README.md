...
Crime Incident Reports of Boston 
( https://data.boston.gov/group/public-safety ) 

Tools / libraries: jupyter notebook, sklearn ,pandas,numpy.

Requested:

1.Display graphs that showing the number of crimes per year ,per month and per day.
...
3.Create a new column which represents the day or night information.
(Consider  the time  between 18.00 and 6.00 as night.)
